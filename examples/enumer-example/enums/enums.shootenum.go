// Code generated by "shoot enum -json -text -file=enums.go"; DO NOT EDIT. (v0.7.4)
...
const _light_max = LightRed | LightYello | LightGreen
...
func (s *Status) UnmarshalText(text []byte) error {
	var v_ Status
	var err error
	if v_, err = shoot.ParseEnum[Status](string(text)); err != nil {
		return err
	}
	*s = v_
	return nil
