// Code generated by "shoot enum -json -text -sql -file=enums.go"; DO NOT EDIT. (v0.7.7)
...
const _orderStatus_max = OrderStatusPending | OrderStatusCompleted | OrderStatusCanceled
...
func (o OrderStatus) IsValid() bool {
	_, ok := _orderStatus_string_map[o]
	return ok
}
...
// Value implements the driver.Valuer interface for OrderStatus
